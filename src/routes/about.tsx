...
export default function About() {
    ...
    const hallOfFameWinners = [
        {
            year: "2017",
            team: "Spiders",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2017w.webp"
        },
        {
            year: "2018",
            team: "Stratos",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2018%20w.webp"
        },
        {
            year: "2019",
            team: "Spiders",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2019%20win.webp"
        },
        {
            year: "2022",
            team: "Spiders",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2022w.webp"
        },
        {
            year: "2023",
            team: "Spiders",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2023w.webp"
        },
        {
            year: "2024",
            team: "Team Hubes",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2024w.webp"
        },
        {
            year: "2025",
            team: "Gazelles",
            image: "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2025w.webp"
        }
    ];
    ...
    const galleryThumbnails = {
        "2022": "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/2022/ABK22%20147.webp",
        "2023": "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/2023/ACCRA'S%20BOOGIE%20KING%2023%20FIRST%20LOVE%20CHURCH%20DAG%20HEWARD-MILLS_145.webp",
        "2024": "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2024w.webp",
        "2025": "https://pub-792299b5bd0346ff962308668cb1f98f.r2.dev/Hall%20of%20Fame/2025w.webp",
    };

    const gradientButtonStyle = {
        background: 'linear-gradient(#05070a, #05070a) padding-box, linear-gradient(90deg, #ff3b00, #ff1f5b, #7a2cff, #00f0ff) border-box',
    ...
    return (
        <div className="flex flex-col min-h-screen text-neutral-content">
            ...
            <main className="pt-28 md:pt-36 flex-grow relative z-10 container mx-auto px-4 pb-20">
                {/* ABOUT Title */}
                <div className="text-center mb-12 animate-fade-in">
                    <h1 className="text-6xl md:text-8xl font-bold text-[#f0b405] tracking-wider uppercase mb-2" style={{ textShadow: '2px 2px 0px #000, 4px 4px 10px rgba(240,180,5,0.4)' }}>
                        About ABK
                    </h1>
                </div>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center mb-20 max-w-6xl mx-auto">
                    <div className="lg:col-span-7 flex flex-col gap-6 text-white/95 text-base md:text-lg leading-relaxed uppercase font-medium">
                        <p>
                            Dance in Ghana has never had a stage this big. Accra's Boogie King reframes dance from a regular dance moment into a nationally significant, cultural and energetic experience, part live competition, part concert. This is a leap within the creative arts industry to help foster emerging talents in the creative landscape and further position the creative arts as an economic driving force.
                        </p>
                        <p>
                            ABK is more than a competition. It is a platform for talent discovery, youth empowerment, creative expression, entertainment and community building.
                        </p>
                    </div>
                ...
                <section className="flex flex-col items-center mb-16">
                    <button
                        ...
                        className="relative group px-12 py-4 rounded-xl font-extrabold text-2xl md:text-3xl text-white tracking-widest overflow-hidden transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] cursor-pointer inline-flex items-center justify-center min-w-[280px] md:min-w-[320px] shadow-[0_0_20px_rgba(255,255,255,0.05)]"
                    ...
                    <div className={`w-full overflow-hidden transition-all duration-500 ease-in-out ${isHallOfFameOpen ? 'max-h-[2000px] opacity-100 mt-10' : 'max-h-0 opacity-0 pointer-events-none'}`}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto px-4">
                            {hallOfFameWinners.slice().reverse().map((winner) => (
                                <div
                                    key={winner.year}
                                ...
                                >
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-white/50 tracking-widest mt-1 uppercase font-semibold">CHAMPION</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <section className="flex flex-col items-center mb-16">
                    ...
                    <div className={`w-full overflow-hidden transition-all duration-500 ease-in-out ${isGalleryOpen ? 'max-h-[2000px] opacity-100 mt-10' : 'max-h-0 opacity-0 pointer-events-none'}`}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto px-4">
                            {Object.keys(galleryData).slice().reverse().map((year) => (
                                <div
                                    key={year}
                                    onClick={() => {
                                ...
                                >
                                    <div className="relative aspect-square rounded-xl overflow-hidden mb-4 border border-white/10 bg-neutral/50">
                                        <img
                                            src={galleryThumbnails[year as keyof typeof galleryThumbnails]}
                                            alt={`ABK ${year}`}
                                            className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                                            loading="lazy"
                                        />
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-white/50 tracking-widest mt-1 uppercase font-semibold">
                                            {galleryData[year as keyof typeof galleryData].length} PHOTOS
                                        </p>
                                    </div>
                                </div>
                            ))}
                ...
                <section className="flex justify-center mb-8">
                    <button
                        className="relative group px-12 py-5 rounded-xl font-extrabold text-2xl md:text-3xl text-white tracking-widest overflow-hidden transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] cursor-pointer inline-flex items-center justify-center min-w-[280px] md:min-w-[320px] shadow-[0_0_20px_rgba(255,255,255,0.05)]"
                        style={gradientButtonStyle}
                    >
                        SPONSOR ABK
                    </button>
            ...
            {selectedYear && (
                <div className="fixed inset-0 z-50 flex flex-col justify-between bg-black/95 backdrop-blur-lg p-4 md:p-8 animate-in fade-in duration-300">
                    ...
                    {/* Modal Content */}
                    <div className="flex-grow overflow-y-auto max-h-[75vh] px-2 flex items-center justify-center">
                        {activeImageIndex === null ? (
                            /* Grid View of all images in selected year */
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 w-full max-w-6xl max-h-full">
                                {galleryData[selectedYear as keyof typeof galleryData].map((imgUrl, idx) => (
                                    <div
                                        key={idx}
                            ...
                            <div className="relative w-full h-full max-w-5xl flex items-center justify-center select-none">
                                ...
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        const images = galleryData[selectedYear as keyof typeof galleryData];
                                ...
                                <div className="max-w-full max-h-[60vh] md:max-h-[70vh] rounded-2xl overflow-hidden shadow-2xl border border-white/10 relative">
                                    <img
                                        src={galleryData[selectedYear as keyof typeof galleryData][activeImageIndex]}
                                    ...
                                    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/75 text-white/95 px-4 py-1.5 rounded-full text-xs md:text-sm font-bold tracking-widest border border-white/10">
                                        {activeImageIndex + 1} / {galleryData[selectedYear as keyof typeof galleryData].length}
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-center gap-4 py-4 border-t border-white/10 mt-6 min-h-[60px]">
                        {activeImageIndex !== null && (
                            <button
